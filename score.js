...
export async function processView(view,{contrast=130,invert=false,cutout=true,cropX=0,cropY=0,cropHeight=100,cropWidth=100}={}){
  ...
  // One continuous source crop is stretched to the complete G2 canvas.
